minetest.register_entity('automobiles_nope:player_mesh',{
initial_properties = {
	    physical = false,
...
function motorcycle.attach_driver_stand(self, player)
    ...
    local driver_mesh=minetest.add_entity(pos,'automobiles_nope:player_mesh')
...
function motorcycle.attach_pax_stand(self, player)
    ...
    if self._passenger == nil then
        ...
        --create the dummy mesh
        local pos = player:get_pos()
        local pax_mesh=minetest.add_entity(pos,'automobiles_nope:player_mesh')
