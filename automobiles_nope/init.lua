...
dofile(minetest.get_modpath("automobiles_nope") .. DIR_DELIM .. "nope_player.lua")
dofile(minetest.get_modpath("automobiles_nope") .. DIR_DELIM .. "nope_entities.lua")
dofile(minetest.get_modpath("automobiles_nope") .. DIR_DELIM .. "nope_crafts.lua")
